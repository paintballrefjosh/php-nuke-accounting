...
$module_version = "3.0";
$module_description = "A PHP-Nuke module for customers to use to view their current account status. Admins can manage invoices, services attached to each invoice, view paid/unpaid invoices, manage users, and much more!";
